...
# Configuration
DB_PATH="${DB_PATH:-/path/to/tiktok-whisper/data/transcription.db}"
...
MIGRATION_DIRS=$(find /path/to/tiktok-whisper/data/migration -type d -name "20*" 2>/dev/null | tail -5)
