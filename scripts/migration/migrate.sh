...
# 设置实际的数据库路径
export DB_PATH="/path/to/tiktok-whisper/data/transcription.db"
export MIGRATION_BASE_DIR="/path/to/tiktok-whisper/data/migration"
...
# 执行迁移步骤
cd /path/to/tiktok-whisper/scripts/migration
