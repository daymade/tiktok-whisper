...
The project includes a powerful tool for converting JSON transcription data to Markdown format.

**Location:** `tools/export-to-md/`

#### Quick Usage for JSON Files

To convert a standalone JSON file (containing transcription data) to Markdown:

```bash
# 1. Navigate to the export tool directory
cd tools/export-to-md

# 2. Copy your JSON file to the current directory
cp "/path/to/your/file.json" ./your_file.json

# 3. Convert using the html2md tool
uv run python "/Volumes/SSD2T/Download/20250120/Archive/python/html2md/main.py" your_file.json

# 4. Move the generated ZIP file to desired location
mv your_file.zip "/desired/output/path/your_file_transcriptions.zip"
...
Real examples of successful conversions:

```bash
# Convert 杨璇.json
cd tools/export-to-md
cp "/Users/tiansheng/杨璇.json" ./杨璇.json
uv run python "/Volumes/SSD2T/Download/20250120/Archive/python/html2md/main.py" 杨璇.json
mv 杨璇.zip "/Users/tiansheng/杨璇_transcriptions.zip"
rm 杨璇.json

# Convert 经纬第二期.json 
cp "/Users/tiansheng/经纬第二期.json" ./经纬第二期.json
uv run python "/Volumes/SSD2T/Download/20250120/Archive/python/html2md/main.py" 经纬第二期.json
mv 经纬第二期.zip "/Users/tiansheng/经纬第二期_transcriptions.zip"
rm 经纬第二期.json

# Convert 美业郭珂妍.json
cp "/Users/tiansheng/美业郭珂妍.json" ./美业郭珂妍.json
uv run python "/Volumes/SSD2T/Download/20250120/Archive/python/html2md/main.py" 美业郭珂妍.json
mv 美业郭珂妍.zip "/Users/tiansheng/美业郭珂妍_transcriptions.zip"
rm 美业郭珂妍.json
```
...
The tool will:
- Split large JSON files into multiple Markdown files (typically 50 records per file)
- Generate individual Markdown files with meaningful names
- Package all files into a ZIP archive for easy distribution
- Clean up temporary files automatically

#### Requirements

- `uv` package manager installed
- Access to the html2md tool at the configured path
- JSON file with transcription data in the expected format